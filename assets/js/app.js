...
/**
 * Toggle search in mobiles devices
 */
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
          ...
          <div class="slider-container">
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <p class="body-3">${module.getHours(dateTimeUnix,
                timezone)}</p>
                ...
                const windLi = document.createElement("li");
                  ...
                  <div class="card card-sm slider-card">
                    ...
                    <img src="./assets/images/weather_icons/direction.png" width="48"height="48" loading="lazy"  alt="direction" class="weather-icon" style="transform: rotate(${windDirection - 100}deg)">
            ...
            for (let i = 7, len = forecastList.length; i < len; i+= 8) {
              ...
              <div class="icon-wrapper">
                <img src="././assets/images/weather_icons/${icon}.png" height="36" width="36"  alt="${description}" class="weather-icon" title="${description}">
